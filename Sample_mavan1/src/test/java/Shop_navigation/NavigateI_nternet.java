...
public class NavigateI_nternet {
	...
	public static WebElement PoplightboxClick() throws Exception{
		try{
			if(WebdriverUtils.findElement(By.xpath("//a[@class='rsx-txt-white rsx-modal-close  rsx-pos-absolute rsx-pad-10 rsx-pad-30-top-xs rsx-pad-30-top-sm']")).isDisplayed()){
